...
CREATE TABLE `hotel` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `block` varchar(20) COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE `notice` (
  ...
  `content` varchar(320) COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE `service` (
  ...
  CONSTRAINT `service_ibfk_1` FOREIGN KEY (`hotel_id`) REFERENCES `hotel` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2016-12-23 10:45:08
